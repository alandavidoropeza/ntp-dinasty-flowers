...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center bg-gradient-nature overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <a
              href="#"
              className="inline-flex bg-gradient-hero text-white font-semibold px-8 py-4 rounded-xl shadow-elegant hover:shadow-gold transition-all duration-300 transform hover:-translate-y-1"
            >
                Request a quote
